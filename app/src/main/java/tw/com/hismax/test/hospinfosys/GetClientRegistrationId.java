 ...
 */
public class GetClientRegistrationId {
// ----------類別常數(須自行修改)----------
    /**
     * Google Developers Console 的 Project Number
     */
    public final static String SENDER_ID = "99262725025";
    // ----------類別列舉----------
...
// ----------類別方法----------
    ...
    // ----------建構子----------
    public GetClientRegistrationId(Activity activity) {
        this(activity, null);
    }
    public GetClientRegistrationId(Activity activity, MagicLenGCMListener listener) {
...
// ----------物件方法----------
    ...
    public String getRegistrationId() {
        ...
        // 檢查程式是否有更新過
        int registeredVersion = prefs.getInt(GetClientRegistrationId.PROPERTY_APP_VERSION,
                Integer.MIN_VALUE);
